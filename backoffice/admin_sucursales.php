...
if ( ValidateModuleParameters($_GET['MOD'], 'sucursales') ){
	$Opc = $_GET['MOD'];
}

$file = 'sucursales/'.$Opc.'.php';
include($file);
...
// Menu Categorias
$Menu->AddOpcion(1, 'Sucursales');
$Menu->AddOpcionLink(1, 1, 'Nueva Sucursal', $mod_Script, array('MOD'=>'sucursales', 'ACC'=>ACC_ALTA));
$Menu->AddOpcionLink(1, 2, 'Lista Sucursales',$mod_Script, array('MOD'=>'sucursales','PVEZ'=>_SI));
...
// Modulo
$Modulo = new nyiModulo('SUCURSALES', 'base_modulo.htm');
