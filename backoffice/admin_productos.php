...
if ( ValidateModuleParameters($_GET['MOD'], 'productos') ){
	$Opc = $_GET['MOD'];
}

$file = 'productos/'.$Opc.'.php';
include($file);
...
$Menu->AddOpcionLink(1, 1, 'Nueva Categoria', $mod_Script, array('MOD'=>'categorias_producto', 'ACC'=>ACC_ALTA));
$Menu->AddOpcionLink(1, 2, 'Lista Categorias',$mod_Script, array('MOD'=>'categorias_producto','PVEZ'=>_SI));

// Menu Novedades
$Menu->AddOpcion(2, 'Productos');
$Menu->AddOpcionLink(2, 1, 'Nuevo Producto', $mod_Script, array('MOD'=>'productos', 'ACC'=>ACC_ALTA));
$Menu->AddOpcionLink(2, 2, 'Lista Productos',$mod_Script, array('MOD'=>'productos','PVEZ'=>_SI));
...
// Modulo
$Modulo = new nyiModulo('PRODUCTOS', 'base_modulo.htm');
