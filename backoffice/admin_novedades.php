...
if ( ValidateModuleParameters($_GET['MOD'], 'novedades') ){
	$Opc = $_GET['MOD'];
}

$file = 'novedades/'.$Opc.'.php';
include($file);
...
$Menu->AddOpcionLink(1, 1, 'Nueva Categoria', $mod_Script, array('MOD'=>'categorias_novedad', 'ACC'=>ACC_ALTA));
$Menu->AddOpcionLink(1, 2, 'Lista Categorias',$mod_Script, array('MOD'=>'categorias_novedad','PVEZ'=>_SI));
//$Menu->AddOpcionLink(1, 3, 'Ordenar Categorias',$mod_Script, array('MOD'=>'ordenacion_categorias_novedades'));

// Menu Novedades
$Menu->AddOpcion(2, 'Novedades');
$Menu->AddOpcionLink(2, 1, 'Nueva Novedad', $mod_Script, array('MOD'=>'novedades', 'ACC'=>ACC_ALTA));
$Menu->AddOpcionLink(2, 2, 'Lista Novedades',$mod_Script, array('MOD'=>'novedades','PVEZ'=>_SI));
$Menu->AddOpcionLink(2, 3, 'Ordenar Novedades',$mod_Script, array('MOD'=>'ordenacion_novedades'));
...
// Modulo
$Modulo = new nyiModulo('NOVEDADES', 'base_modulo.htm');
