...
if ( ValidateModuleParameters($_GET['MOD'], 'eventos') ){
	$Opc = $_GET['MOD'];
}

$file = 'eventos/'.$Opc.'.php';
include($file);
...
// Menu Categorias
$Menu->AddOpcion(1, 'Opciones');
$Menu->AddOpcionLink(1, 1, 'Nuevo Evento', $mod_Script, array('MOD'=>'eventos', 'ACC'=>ACC_ALTA));
$Menu->AddOpcionLink(1, 2, 'Eventos agendados',$mod_Script, array('MOD'=>'eventos', 'PVEZ'=>_SI));
...
// Modulo
$Modulo = new nyiModulo('AGENDA DE EVENTOS', 'base_modulo.htm');
